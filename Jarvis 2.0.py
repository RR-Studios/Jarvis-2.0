...
def usrname():
	...
	print("Welcome Mr.YOUR name", uname.center(columns))
	print("#####################".center(columns))
...
if __name__ == '__main__':
	...
	while True:
		...
		if 'wikipedia' in query:
			...
			speak("I have been created by Sir Raman.")
			...
			try:
				jsonObj = urlopen('''https://newsapi.org / v1 / articles?source = the-times-of-india&sortBy = top&apiKey =\\times of India Api key\\api key''')
		...
		elif "go in hibernate" in query or "sleep" in query:
			speak("Hibernating")
			subprocess.call("shutdown / h")

		elif "log off my pc" in query or "sign out" in query:
		...
		elif "will you be my Bestfriend" in query or "will you be my bestfriend" in query:
